...
mod test {
    ...
    use crate::ch_09_02::test_helper::BusSpy;

    use super::super::test_helper::test_helper::{
    ...
    fn changing_email_from_corporate_to_non_corporate() -> Result<(), Box<dyn error::Error>> {
        ...
        // let bus_spy = RefCell::new(BusSpy::new(RefCell::new(vec![])));
        ...
        // let mut sut =
        //     UserController::new(db, EventDispatcher::new(message_bus, domain_logger_mock));
        ...
        //     .with_email_changed_message(user.user_id, "new@example.com");
